    ...
    <div className="relative w-full h-full bg-gradient-to-br from-base-800 to-base-900 rounded-2xl overflow-hidden flex items-center justify-center">
      ...
      <div className="relative flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="font-display font-semibold">{companyName || "AI"} Interviewer</p>
          <p className="text-slate-500 text-xs">{isSpeaking ? "Speaking" : "Listening"}</p>
        </div>

        {/* Voice waveform bars, only animate while speaking */}
      ...
      {/* Top-left "live" badge like real video calls */}
